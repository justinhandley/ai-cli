...
const helpCommand = new Command('help')
    ...
    .action(async () => {
        ...
        console.log(chalk.gray('  collect [directory]         Collect files from a directory'));
        console.log(chalk.gray('    -c, --config <name>      Use a specific collection configuration'));
        ...
        console.log(chalk.gray('  config-collect list        List all collection configurations'));
        console.log(chalk.gray('  config-collect create      Create a new collection configuration'));
        console.log(chalk.gray('  config-collect edit <name> Edit an existing collection configuration'));
        console.log(chalk.gray('  config-collect delete <name> Delete a collection configuration'));
        console.log(chalk.gray('  config-collect set-default <name> Set a configuration as default'));
